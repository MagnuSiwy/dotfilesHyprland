...
# yay -S swaylock-effects-git tela-icon-theme nwg-look bibata-cursor-theme

# Podczas instalacji: nano os-prober xdg-user-dirs xdg-user-dirs-gtk nvidia(i wszystko do niej) base-devel ntfs-3g linux-zen-headers linux-lts-headers
# Po: xdg-user-dirs-update
